...
## Required Tools
- `aegisml_sandbox_analyzeModel` - Run comprehensive analysis (deep profile)
- `aegisml_sandbox_getLatestReport` - Check for existing analysis
...
- If not available, call `aegisml_sandbox_analyzeModel`:
  ```json
  {
...
**AegisML Version:** [runner_version]
...
- **AegisML Runner Version:** [runner_version]
- **Schema Version:** [schema_version]
- **Full Report:** `./sandbox_logs/aegisml_[run_id].json`
...
- **[Date]** - Re-tested with AegisML v[X.Y.Z]
...
```bash
# Analyze this model
python aegisml_sandbox_cli.py --model [model_path] --profile deep

# Run security audit
python aegisml_sandbox_cli.py --model [model_path] --profile attack

# View latest report
python aegisml_sandbox_cli.py --summary --model [model_path]
```

---

*This model card was automatically generated by AegisML. For questions about this model's safety characteristics, review the detailed analysis report.*
```
...
- **Dependencies:** aegisml_sandbox_cli.py with deep profile
